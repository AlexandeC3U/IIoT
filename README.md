...
```
                                    ...
                                    ║                                                               ║
    ┌──────────────┐               ║  ┌─────────────────────────────────────────────────────────┐  ║
    │   Siemens    │───S7 Comm────▶║  │                   PROTOCOL GATEWAY LAYER               │  ║
    │   S7-1500    │               ║  │  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐   │  ║
    └──────────────┘               ║  │  │   S7    │  │  OPC UA │  │ Modbus  │  │  MQTT   │   │  ║
                                   ║  │  │ Gateway │  │ Gateway │  │ Gateway │  │ Native  │   │  ║
    ┌──────────────┐               ║  │  └────┬────┘  └────┬────┘  └────┬────┘  └────┬────┘   │  ║
    │   OPC UA     │───OPC UA─────▶║  │       │            │            │            │        │  ║
    │   Server     │               ║  │       └────────────┴────────────┴────────────┘        │  ║
    └──────────────┘               ║  │                          │                             │  ║
...
└─────────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    │                                                                                       │
    │   1. Receive new device configuration                                                │
    │   2. Instantiate OPC UA client for endpoint                                          │
    │   3. Create subscriptions for selected tags                                          │
...
- [ ] Protocol Gateway (S7, OPC UA, Modbus)
